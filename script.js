document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("add-btn").addEventListener("click", function () {
        ...
        transactionHistory.push({ type: "income", amount: incomeAmount, date: incDate, category: details });
        saveTransactions();
    ...
    document.getElementById("addibtn").addEventListener("click", function () {
        ...
        transactionHistory.push({ type: "expense", amount: expenseAmount, date: expenseDate, category: expenseDetails });
        saveTransactions(); 
...
async function generateInsights() {
    ...
    let highestExpenseCategory = Object.keys(expenseSummary).reduce((a, b) => (expenseSummary[a] > expenseSummary[b] ? a : b), "");
    ...
    try {
        ...
        if (data.choices && data.choices.length > 0) {
            document.getElementById("ai-output").innerText = data.choices[0].text;
        } else {
